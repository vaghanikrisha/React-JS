...
const View = () => {
    ...
    const deleteCourse =(id) =>{
        ...
        setRecord(d);
        toast.error(" Your Data is Deleted Successfully..");
    }

    const allDelete =() =>{
        if(mdelete.length == 0){
            toast("minimum 1 row is selected...");
            return false;   
        }
                    ...
                    <table className="table">
                        <thead>
                            <tr align="center"  style={{fontSize:"19px"}}>
                                ...
                                <th style={{width:"16.66%"}} scope="col">First Name </th>
                                <th style={{width:"16.66%"}} scope="col">Last Name </th>
